...
def meniu():
    ...
    try:
        ...
        desireProgram = input("Please enter the desire program\n")
    except:
        print("Wrong format")
        exit()
    person()
    if(desireProgram=="BKT"):
        BackTracking(initialize_state())
    elif(desireProgram=="BFS"):
        BFS(initialize_state())
    elif(desireProgram=="Hillclimbing"):
        Hillclimbing(initialize_state())
    elif(desireProgram=="A*"):
        A_star(initialize_state())
    else:
